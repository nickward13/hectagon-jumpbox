...
az vm create --name hectagon-jumpbox-linux --resource-group hectagon-jumpbox --image ubuntults --size Standard_DS2 --ssh-key-value @~/.ssh/id_rsa.pub --subnet $SUBNET_ID --public-ip-address-dns-name hectagonlinux
az vm create --name hectagon-jumpbox-win --resource-group hectagon-jumpbox --image Win2016Datacenter --size Standard_DS2 --subnet $SUBNET_ID --public-ip-address-dns-name hectagonwin --admin-username nickward
